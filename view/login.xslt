...
<body style="font-family:Arial;font-size:12pt;background-color:white; display:flex; align-items:center;flex:center;margin-left: 42%; flex-direction:row;">
    <xsl:for-each select="data/user">
    <div style="background-color:teal;color:white;padding:4px; box-shadow: 20px 15px 15px gray ; padding: 6%;">
      <h1 style="display:flex; flex-direction:column;">Login</h1>
